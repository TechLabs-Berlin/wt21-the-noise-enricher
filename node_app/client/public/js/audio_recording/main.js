// Copied from here: https://github.com/daaain/JSSoundRecorder
...
function createDownloadLink() {
    ...
    recorder && recorder.exportWAV(downloadSound.bind(this)); // handleWAV.bind(this)
}

function downloadSound(blob) {
    var url = URL.createObjectURL(blob);
    var audioElement = document.createElement('audio');
    audioElement.controls = true;
    audioElement.src = url;
    document.getElementById("uploadTrack").appendChild(audioElement);
}
